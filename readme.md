...
<p>Projeto que desenvolvi uma página com uma tabela com opções de preços/planos do produto/serviço.</p>
...
$ git clone https://github.com/dimasdevspro/pricingtable
